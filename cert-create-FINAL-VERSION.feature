...
Feature: Lập chứng từ khấu trừ thuế thu nhập cá nhân
  ...
  Rule: Tính toán thuế tự động
    ...
    Scenario: Tính thu nhập tính thuế
      ...
      Then thu nhập tính thuế là 26,850,000 VNĐ

    @tax-calculation
    Scenario: Tính số thuế theo biểu lũy tiến
      Given thu nhập tính thuế là 26,850,000 VNĐ
      When hệ thống tính số thuế
      Then số thuế là 3,827,500 VNĐ

    @tax-calculation
    Scenario: Cập nhật tự động khi thay đổi bảo hiểm
      Given thu nhập chịu thuế là 30,000,000 VNĐ
      And bảo hiểm là 2,000,000 VNĐ
      And thu nhập tính thuế là 28,000,000 VNĐ
      When kế toán thay đổi bảo hiểm thành 3,150,000 VNĐ
      Then thu nhập tính thuế tự động cập nhật thành 26,850,000 VNĐ
      And số thuế tự động cập nhật thành 3,827,500 VNĐ

    @tax-calculation
    Scenario: Cập nhật tự động khi nhập quỹ hưu trí
      Given thu nhập chịu thuế là 30,000,000 VNĐ
      And bảo hiểm là 3,150,000 VNĐ
      And thu nhập tính thuế là 26,850,000 VNĐ
      When kế toán nhập quỹ hưu trí tự nguyện 1,000,000 VNĐ
      Then thu nhập tính thuế tự động cập nhật thành 25,850,000 VNĐ
  ...
  Rule: Tính thuế cho nhiều tháng
    ...
    Scenario: Tính thuế cho cả năm
      ...
      And bảo hiểm mỗi tháng là 3,150,000 VNĐ
      When hệ thống tính toán thuế
      Then thu nhập tính thuế mỗi tháng là 26,850,000 VNĐ
      And số thuế mỗi tháng là 3,827,500 VNĐ
      And tổng số thuế cả năm là 45,930,000 VNĐ
